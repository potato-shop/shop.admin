<template>
  <AuthLayout show-footer footer-class="mt-3">
    ...
    <div class="mx-auto text-center">
      ...
      <p class="text-muted fs-12 mb-3">The server could not understand the request due to invalid syntax. Please check
        your input and try again.</p>
      <router-link to="/" class="btn btn-primary">Back To Home <i class="ti ti-home ms-1"></i></router-link>
    </div>
  </AuthLayout>
</template>
...
import err400 from "@/assets/images/error/error-400.png"
</script>