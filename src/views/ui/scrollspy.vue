<template>
  <VerticalLayout>
    ...
    <UICard title="Example in navbar">
        ...
        <ul class="nav nav-pills">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button"
              aria-haspopup="true" aria-expanded="false">Dropdown <i class="ti ti-chevron-down"></i></a>
      ...
      <div id="navbar-example21" data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"
    ...
    <UICard title="Example with nested nav">
      <b-row>
        ...
        <b-col cols="10">
          <div id="navbar-example31" data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-offset="0" class="scrollspy-example" style="height: 350px;">
